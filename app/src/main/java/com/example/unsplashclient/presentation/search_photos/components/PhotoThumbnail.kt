...
import com.example.unsplashclient.presentation.UnsplashClientTheme
...
private fun PhotoThumbnailPreview(){
    val photo = Photo(
        ...
        likes = 100,
        imageUrl = "https://images.unsplash.com/photo-1676370752810-b1bfe1843ddb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw4fHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60",
